...
kdataset_salida  <- "paquete_premium_ext_722_exp_1.csv.gz"
...
AgregarVariables  <- function( dataset )
{
  ...
  # teniendo en cuenta el orden de importancia de variables obtenido en scripts anteriores
  # combino variables de importancia como nuevas features
  dataset[  , mpasivos_margen_sobre_mactivos_margen  := mpasivos_margen / mactivos_margen ]
  dataset[  , mpayroll_sobre_cpayroll_trx  := mpayroll / cpayroll_trx ]
  dataset[  , mcaja_ahorro_sobre_mcuentas_saldo  := mcaja_ahorro / mcuentas_saldo ]
  dataset[  , mpayroll_sobre_mtarjeta_visa_consumo  := mpayroll / mtarjeta_visa_consumo ]
  dataset[  , mrentabilidad_annual_sobre_mprestamos_personales  := mrentabilidad_annual / mprestamos_personales ]
...
#--------------
# Agrego las medias moviles 3 y 6
