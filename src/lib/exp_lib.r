...
# RESEARCH2_EXP-8221b -- utilizar lag 1. Tendencias 3,6. Delta 1. Canaritos final 0.1
# exp_start( "8221FEb", deletevm= FALSE  )
...
# RESEARCH_EXP-8222a
# exp_start( "8222TSa", deletevm= FALSE  )
# exp_start( "8222HTa", deletevm= FALSE  )
# exp_start( "8222ZZa" )

# RESEARCH_EXP-8222b
# exp_start( "8222TSb", deletevm= FALSE  )
# exp_start( "8222HTb", deletevm= FALSE  )
# exp_start( "8222ZZb" )
...
# RESEARCH_EXP-8224a
# exp_start( "8224FEa", deletevm= FALSE  )
# exp_start( "8224TSa", deletevm= FALSE  )
# exp_start( "8224HTa", deletevm= FALSE  )
# exp_start( "8224ZZa" )

# RESEARCH_EXP-8224b
# exp_start( "8224FEb", deletevm= FALSE  )
# exp_start( "8224TSb", deletevm= FALSE  )
# exp_start( "8224HTb", deletevm= FALSE  )
# exp_start( "8224ZZb" )

# RESEARCH_EXP-8224c
# exp_start( "8224FEc", deletevm= FALSE  )
# exp_start( "8224TSc", deletevm= FALSE  )
# exp_start( "8224HTc", deletevm= FALSE  )
# exp_start( "8224ZZc" )

#=========================================

# RESEARCH_EXP-8225a
# exp_start( "8225FEa", deletevm= FALSE  )
# exp_start( "8225TSa", deletevm= FALSE  )
# exp_start( "8225HTa", deletevm= FALSE  )
# exp_start( "8225ZZa" )

#=========================================

# RESEARCH_EXP-8226a
# exp_start( "8226HTa", deletevm= FALSE  )
# exp_start( "8226ZZa" )
...
# RESEARCH_EXP-8228a
# exp_start( "8228TSa", deletevm= FALSE  )
# exp_start( "8228HTa", deletevm= FALSE  )
# exp_start( "8228ZZa" )
