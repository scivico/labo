...
kdataset       <- "./datasets/paquete_premium_ext_721_exp1.csv.gz"
...
kmax_bin           <-    31
klearning_rate     <-     0.0101168702572967
knum_iterations    <-   919
knum_leaves        <-  978
kmin_data_in_leaf  <- 16821
kfeature_fraction  <- 0.498753089172422

kexperimento   <- paste0( kprefijo, "11" )
