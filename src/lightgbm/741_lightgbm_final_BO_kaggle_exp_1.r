...
kdataset       <- "./datasets/paquete_premium_ext_722_exp_1.csv.gz"
...
kmax_bin           <-    31
klearning_rate     <-     0.0102245544687446
knum_iterations    <-   2523
knum_leaves        <-  16
kmin_data_in_leaf  <- 19964
kfeature_fraction  <- 0.252386874223783

kexperimento   <- paste0( kprefijo, "FEAV11" )
