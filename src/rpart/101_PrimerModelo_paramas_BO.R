...
modelo  <- rpart("clase_ternaria ~ .",  #quiero predecir clase_ternaria a partir de el resto de las variables
                 data = dtrain,
                 xval=0,
                 cp= -0.962960519,   #esto significa no limitar la complejidad de los splits
                 minsplit=  2400,     #minima cantidad de registros para que se haga el split
                 minbucket=  714,     #tamaño minimo de una hoja
