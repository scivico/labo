...
ksemillas  <- c(101489, 101501, 101503, 101513, 101527) #reemplazar por las propias semillas
...
for( vcomplex  in  c( -0.5,-0.3,-0.1, 0.1,0.3,0.5 )  )
{
for( vmax_depth  in  c( 4, 6, 8, 10, 12, 14, 16, 18, 22, 25,30)  )
{
  ...
  param_basicos  <- list( "cp"= vcomplex,       #complejidad minima
