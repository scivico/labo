...
param_basicos  <- list( "cp"=  -0.9629605,  #complejidad minima
                        "minsplit"= 2400,     #minima cantidad de registros en un nodo para hacer el split
                        "minbucket"=  714,     #minima cantidad de registros en una hoja
